...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-TN3PSZIR.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-FLWEEGYC.js"), act = await getAct();
...
//# sourceMappingURL=chunk-RZRWO6QZ.js.map
