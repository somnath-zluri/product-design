...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-QCDEGCBT.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-2K36PZAE.js"), act = await getAct();
...
//# sourceMappingURL=chunk-FP2F4MIT.js.map
